  ...
  return (
    <>
      <div className='bg-[#202b3b] my-6 rounded-3xl'>
        <p className='pl-12 text-gray-300'>{t("air")} </p>
        <div className='grid grid-cols-2 px-12 py-2 gap-4'>
          <div>
            <div className='flex gap-2 items-center'>
              ...
              <p className='text-gray-200 '>{t("uv")}</p>
            </div>
          ...
          <div>
            <div className='flex gap-2 items-center'>
              ...
              <p className='text-gray-200 '>{t("rainChance")} </p>
            </div>
          ...
          <div>
            <div className='flex gap-2 items-center'>
              ...
              <p className='text-gray-200 '>{t("wind")}</p>
            </div>
          ...
          <div>
            <div className='flex gap-2 items-center'>
              ...
              <p className='text-gray-200 '>{t("feels")} </p>
            </div>
